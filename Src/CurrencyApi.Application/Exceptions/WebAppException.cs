...
{
    /// <summary>
    /// Represents errors that occur during web application execution
    /// </summary>
    [Serializable]
    public class WebAppException : Exception
    {
        ...
        public WebAppException(string messageFormat, params object[] args) : base(string.Format(messageFormat, args))
        {
        }
        ...
        protected WebAppException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
