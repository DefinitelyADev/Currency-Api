        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlphabeticCode = table.Column<string>(type: "character(3)", fixedLength: true, maxLength: 3, nullable: false),
                    NumericCode = table.Column<int>(type: "integer", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    OriginCurrencyId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CurrencyRates_Currencies_OriginCurrencyId",
            ...
            migrationBuilder.InsertData(
                table: "Currencies",
                columns: new[] { "Id", "AlphabeticCode", "DecimalDigits", "Name", "NumericCode" },
                values: new object[,]
                {
                    { 1, "EUR", (short)2, "Euro", 978 },
                    { 2, "USD", (short)2, "United States dollar", 840 },
                    { 3, "JPY", (short)0, "Japanese yen", 392 },
                    { 4, "CHF", (short)2, "Swiss franc", 756 },
                    { 5, "CAD", (short)2, "Canadian dollar", 124 },
                    { 6, "GBP", (short)2, "Pound sterling", 826 }
                });

            migrationBuilder.InsertData(
                table: "CurrencyRates",
                columns: new[] { "Id", "OriginCurrencyId", "Rate", "TargetCurrencyId" },
                values: new object[,]
                {
                    { 1, 2, 1.3764m, 1 },
                    { 4, 3, 76.7200m, 2 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrencyRates_OriginCurrencyId_TargetCurrencyId",
                table: "CurrencyRates",
                columns: new[] { "OriginCurrencyId", "TargetCurrencyId" },
                unique: true);
